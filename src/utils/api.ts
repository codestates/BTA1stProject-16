...
// // 라이브러리 api 호출 path 맞는지 확인
// const hermez = require('@hermeznetwork/hermezjs');
// // const { Harmony } = require('@hermeznetwork/hermezjs/core');
// const { Account, Wallet } = require('@hermeznetwork/hermezjs/account');
...
//   Unit,
//   toAscii
// } = require('@hermeznetwork/hermezjs/utils');
...
//   encryptPhrase,
//   decryptPhrase
// } = require('@hermeznetwork/hermezjs/crypto');

// let shardURL = 'https://api.s0.b.hmny.io/'; //앤드포인트 URL
// let hmz = new hermez(
//   shardURL,
//   {
//       chainType: ChainType.hermez,
//       chainId: ChainID.HmzTestnet,
//   },
// );
